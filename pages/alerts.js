  ...
  ComfyJS.onCommand = (user, command, message, flags, extra) => {
    if (extra.timestamp !== timeStampComando) {
      ...
      switch (comando) {
        case 'comandos':
          ComfyJS.Say(
            `/me !faiskolas !doar !sub !prime !membro !raiz !instagram !discord !youtube !lista !rank !pedirmusica !overlay !steam !psn !pipi !mamar !pergunta !dinheiro !codigo !saque`
          );
          break;
        case 'dinheiro':
          ComfyJS.Say(
        ...
        case 'overlay':
          ComfyJS.Say(
            `/me ${user} Compre na 🍑 loja com suas !faiskolas os itens: [Overlay RGB] - Duração: 2min | [Overlay] - Duração: 1min; Cores disponíveis: verde, rosa, roxo, branco, vermelho, amarelo, laranja, azul(padrão).`
          );
          break;
        case 'raiz':
          ComfyJS.Say(
        ...
        case 'rank':
          ComfyJS.Say(
            `/me ${user} Rank dos usuários que mais pediram músicas no CloneHero: https://faiska.vercel.app/leaderboard`
          );
          break;
        case 'lista':
          ComfyJS.Say(
            `/me ${user} Lista de músicas do CloneHero: https://faiska.vercel.app/songlist`
          );
          break;
        case 'pedirmusica':
          ComfyJS.Say(
            `/me ${user} Pra pedir música nas lives de CloneHero é só comprar o item "Pedir Música" na 🍑 loja e digitar o código da música que tu pega em !lista`
          );
          break;
        case 'pipi':
          if (message) {
